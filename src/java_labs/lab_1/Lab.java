...
public class Lab {
    public static void start() {
        while(true) {
            ...
            switch (choice) {
                case 1:
                    java_labs.lab_1.problem_1.Problem1.start();
                    break;
                case 2:
                    java_labs.lab_1.problem_2.Problem2.start();
                    break;
                case 3:
                    java_labs.lab_1.problem_3.Problem3.start();
                    break;
                case 4:
                    java_labs.lab_1.problem_4.Problem4.start();
                    break;
                case 5:
                    java_labs.lab_1.problem_5.Problem5.start();
                    break;
                case 6:
